...
public class Menu extends JPanel {
    ...
    public final String menuItemsAdmin[][] = {
        {"~MAIN~"},
        {"Dashboard"},
        {"~MASTER~"},
        {"Produk"},
    ...
    public final String menuItemsUser[][] = {
        {"~MAIN~"},
        {"Dashboard"},
        {"~TRANSAKSI~"},
        {"Penjualan"},
    ...
    private final String headerName = "APP KASIR";
    ...
    private void init() {
        ...
        header.setIcon(new ImageIcon(getClass().getResource("/com/kasir/icon/logo.png")));
